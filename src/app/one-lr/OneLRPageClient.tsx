...
import type { LRData } from '@/lib/types';
import type { LucideIcon } from 'lucide-react';
import { Bed, Activity, AlertCircle, ArchiveX, Baby, Building2, ChevronDown, ChevronUp, Clock } from 'lucide-react';
...
const OneLRPageClient: React.FC<OneLRPageProps> = ({ data }) => {
  return (
...
export default OneLRPageClient;